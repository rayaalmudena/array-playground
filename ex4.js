...
console.log(items.some((e)=> e.text.includes("Ballena"))); //TODO. Resultado esperado: false
...
console.log(items.some((e)=>e.Tags.includes("ES6"))); //TODO. Resultado esperado: true (la última!)
