...
champions.sort((a,b)=> b.stats.hp - a.stats.hp); //mas a menos
console.log(champions.map((e)=> e.id+"-"+e.stats.hp)); // TODO: ordenar por vida inicial

champions.sort((a,b)=> a.stats.hp - b.stats.hp); //menos a mas
console.log(champions.map((e)=> e.id+"-"+e.stats.hp)); // TODO: ordenar por vida inicial